            ...
            <div class="table-container">
                <div class="cell-container">
                    <div class="app-brief">
                        ...
                        <p class="scan-tips"><span class="i18n" name="smewmxz"></span><br /><span class="i18n" name="ysjllqsrwz"></span>：<span class="text-black">{{$app->url}}</span></p>
...
<script type="text/javascript" src="/fenfa//static/i18n/language.js?v=1.026"></script>
